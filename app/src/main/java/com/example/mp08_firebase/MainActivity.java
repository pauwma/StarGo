...
public class MainActivity extends AppCompatActivity {
    ...
    private List<Integer> fragmentsWithoutBottomNav = Arrays.asList(R.id.signInFragment, R.id.settingsFragment, R.id.recuperacionFragment, R.id.registerFragment, R.id.newPostFragment, R.id.seleccionViajeFragment, R.id.reservaViajeFragment);
